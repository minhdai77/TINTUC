<div id="baimoi">
  ...
  <div class="rows">
    <h4><a href="<?=BASE_DIR.$this->lang;?>/article/cat/<?=$lt['idloai']?>">
      <?=$lt['tenloai']?>
      </a></h4>
    ...
    <div class="tindau"> <img src="<?=BASE_DIR?>img/<?=$bai['urlhinh'];?>" align=left />
      <div class="tieude"><a href="<?=BASE_DIR.$this->lang;?>/article/detail/<?=$bai['idbv'];?>">
        <?=$bai['tieude'];?>
        </a></div>
      <div class="tomtat">
        <?=$bai['tomtat'];?>
    ...
    <div class="tintieptheo">
      ...
      <p class="tieude"> <a href="<?=BASE_DIR.$this->lang;?>/article/detail/<?=$bai['idbv'];?>">
        <?=$bai['tieude']?>
        </a></p>
      <?php }	//for $j?>
    </div>
